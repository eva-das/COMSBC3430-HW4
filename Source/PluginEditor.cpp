    ...
    : AudioProcessorEditor (&p), audioProcessor (p)
{
    ...
    mPitchSlider.setRange(0.0f, 3.0f, 1.0f);
    mPitchSlider.setValue(0.0f);
    mPitchSlider.addListener(this);
    addAndMakeVisible(mPitchSlider);

    mGainLabel.setText("Gain Slider", juce::dontSendNotification);
    mGainLabel.attachToComponent(&mGainSlider, false);
    addAndMakeVisible(mGainLabel);

    mPitchLabel.setText("Pitch Slider", juce::dontSendNotification);
